...
- Do not recommend roles in the `Applied / Interview / In-Process` table as new application targets.
- Do not recommend roles with hard experience requirements Matt does not meet.
- Do not recommend bartender roles unless the listing explicitly says no experience required, training provided, experience preferred but not required, or there is a clear barback/server-to-bartender path.
- If local files and live Teal disagree, refresh Teal and use the live status.
- If status is uncertain, label the role `status unknown` and verify before recommending it.

## Applied / Interview / In-Process

| Company / Venue | Role | Status | Evidence |
|---|---|---|---|
| Aba Nashville | Barback | Interview scheduled Friday | User confirmed 2026-05-26; Harri showed applied on 2026-05-25 |
| Friends In Low Places | Barback | Applied | User confirmed 2026-05-26 |
| Kane Brown's | BarBack | Applied | Live Indeed page showed `Applied` on 2026-05-26 |
| Pushing Daisies | Bar Back | Applied | `applications/hospitality-lanes/broadway-barback-teal-intake-2026-05-18.md` says applied 2026-05-25 |
| 51 North Taproom | Server | Applied | Seasoned success screen confirmed application submitted on 2026-05-26 |
| The Twelve Thirty Club | Barback | Rejected | User confirmed on 2026-05-26 that he applied and was rejected |
| Boqueria Nashville | Busser | Applied | Seasoned success screen confirmed application submitted on 2026-05-26; requested Thu 2026-05-28 2:00 PM interview slot |
...
These should not be retried unless a new active posting is found.

| Company / Venue | Role | Reason |
|---|---|---|
...
These should not be recommended unless Matt explicitly reverses the preference.

| Company / Venue | Role(s) | Reason |
|---|---|---|
| Martin's Bar-B-Que Joint | Server / FOH | User said he does not want Martin's; prefers high-volume or high-end venues |
| Taco Bell | All hospitality bridge roles | User said he does not want Taco Bell; prefers higher-value customers |

## Local Artifact Exclusions Until Teal Proves Otherwise

These have local resume/application artifacts and must be treated as already worked or status-uncertain until Teal is refreshed.

| Company / Venue | Role(s) | Reason |
|---|---|---|
| Jason Aldean's Kitchen + Rooftop Bar / TC Restaurant Group | Barback, Server Assistant | Local application pack, resume, cover letter, answers, and review checklist exist |
| Luke Bryan's 32 Bridge / TC Restaurant Group | Barback, Server, Server Assistant | Local role-specific resume artifacts exist |
| Morgan Wallen's This Bar | Barback | Local role-specific resume artifact exists |
| Puttshack | Barback, Server Assistant / Food Runner | Local role-specific resume artifacts exist |
| Assembly Food Hall | Barback | Local role-specific resume artifact exists |
| W Nashville | Barback | Local role-specific resume artifacts exist |
| STK Nashville | Busser, Server | Local role-specific resume artifacts exist |
| Blue Sushi Sake Grill | Server | Local role-specific resume artifacts exist |
| Ember & Oak Nashville | Bartender / Hospitality Launch Support | Local role-specific resume artifact exists |

## Experience-Mismatch Exclusions

| Company / Venue | Role | Reason |
|---|---|---|
| Aba Nashville | Server PM & Weekend AM | Requires 2 years experience in Harri application view |
| Aba Nashville | Bartender PM & Weekend AM | Bartender role is not entry-friendly for Matt unless the employer invites him from the barback interview |
| The Iberian Pig Nashville | Server | High-upside listing, but not an entry-friendly no-experience server target |
| Sushi-san Nashville | Bartender | Listing shows 2 years experience |
...
Before presenting any role as a target, answer:

1. Is it absent from the applied/in-process table?
2. Is it absent from local artifact exclusions, or did live Teal prove it is not applied?
3. Does the listing avoid hard experience requirements?
4. Does pay plausibly beat or improve on the Farm House benchmark?
5. Is the next action clear and non-duplicative?

If any answer is no, do not recommend it.
