...
- When editing a Teal summary, default tenure framing to `in marketing since 2007`. If the artifact clearly expects a years-of-experience claim, use a current year-derived count from the 2007 start year and avoid stale shorthand like `15+ years`.
