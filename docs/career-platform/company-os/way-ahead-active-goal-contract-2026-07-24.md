...
> use ClickUp for scope and status, GitHub for code provenance, and current test
> artifacts for verification. The stage is complete only when the full
> first-user vertical slice works from public website through structured Career
> Profile, Job Standard, approved Job Paths, explainable current-job ranking,
> Pursuit, editable job-specific assets, and the exact external-action approval
> line; fresh mobile, tablet, desktop, Light, Dark, interaction, state,
> accessibility, privacy, and two-user isolation evidence exists; local tests
> and production readbacks pass; independent quality records its verdict;
...
> without the exact reserved approval.

## Why this is the right level

OpenAI's current Codex guidance recommends a clear goal, relevant context,
constraints, and a concrete definition of done. It also says goal objectives
must stay below 4,000 characters and that longer instructions should live in a
file referenced by the goal.

This objective therefore names the outcome, controlling sources, acceptance
evidence, and reserved boundaries while leaving the detailed journey, schema,
screen states, critical path, and economics in their governing documents.

Official guidance:

- [Codex best practices](https://learn.chatgpt.com/guides/best-practices)
- [Codex prompting](https://learn.chatgpt.com/docs/prompting)
- [Codex developer commands and goals](https://learn.chatgpt.com/docs/developer-commands)
