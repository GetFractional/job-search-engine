...
> Scope: Matt-specific operations only. TealHQ is a temporary tool in Matt's personal case-study workflow and a source of dated competitor observations. This document must not define the customer career platform's routes, domain objects, MVP dependencies, or architecture.
